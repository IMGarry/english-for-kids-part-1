import { ICards } from '../src/core/interfase/cards.interface';

import { CardItemsDataType } from '../src/core/constants/constants';
...
export const cardsItemsData = cards.map(
  (c: string[] | Array<CardItemsDataType>) => ({ ...c }),
);
